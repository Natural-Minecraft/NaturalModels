## 📗 Notice
Due to Mojang’s [new version numbering system](https://www.minecraft.net/en-us/article/minecraft-new-version-numbering-system) (e.g., 1.21.x → 26.x), the next NaturalModels feature release will begin at `2.0.0` to avoid confusion with Minecraft versions.  
This also marks the completion of the NaturalModels 1.x series, as its core APIs and features have now reached a stable, finalized state.

Several technical questions are expected to emerge in the near future, and they may influence the evolution of NaturalModels 2.0.0:
...
NaturalModels.model("model").ifPresent(model -> model.create(location, ModelProfile.of(player)));
```
...
[Full change log](https://github.com/toxicity188/NaturalModels/compare/1.14.2...1.15.0)
