# ⚡ NaturalModels 1.14.0

## 📗 Notice
This update introduces significant API changes to the entity adapter.  
Please verify the compatibility of all plugins that depend on NaturalModels.
...
Armor textures can be customized in the NaturalModels/armors directory.
...
[Full change log](https://github.com/toxicity188/NaturalModels/compare/1.13.4...1.14.0)
